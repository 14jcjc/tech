...
現在はフリーで、データサイエンスに関する情報発信を行いながら、個人プロジェクトに取り組んでいます。

上智大学および同大学院 数学研究科修了。  
データサイエンス分野を中心に、システムエンジニア／データサイエンティストとして20年以上の実務経験があります。  
懸賞金付きデータサイエンス・コンテストで準優勝を2度受賞しました。

R を活用したデータ分析やプログラミングが特に好きで、当サイトでも R や SQL に関する話題を中心に扱っています。

プライベートでは、水平思考クイズの制作やミステリー小説・映画を楽しんでいます。  
これまでに解いたウミガメのスープは約1000問にのぼり、その経験を生かしてクイズ問題集も執筆しています。
