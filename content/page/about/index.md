...
長年、データ解析を専門とするエンジニアとして活動してきました。  
現在はフリーで、データサイエンスに関する情報発信を行いながら、いくつかの個人プロジェクトに取り組んでいます。

上智大学および同大学院（数学専攻）修了。  
データサイエンス分野を中心に、システムエンジニア／データサイエンティストとして20年以上の実務経験があります。  
懸賞金付きデータサイエンス・コンテストで準優勝を2度受賞しました。

R を使ったデータ分析やプログラミングが特に好きで、当サイトでも R や SQL に関する話題を中心に扱っています。

一方で、論理パズルや水平思考クイズにも長く親しんできました。  
これまでに解いたウミガメのスープは約1000問にのぼり、その経験を生かしてクイズ問題集の制作・執筆も行っています。

2025年より JAPAN MENSA 会員。  
同会会報誌のクイズコーナーにて、自作クイズが掲載されたことをきっかけに、
「思考の前提を疑う楽しさ」をより多くの人に届けたいと考えるようになりました。

データ分析もクイズも、大切なのは「答え」よりも、そこに至る考え方そのものだと考えています。
